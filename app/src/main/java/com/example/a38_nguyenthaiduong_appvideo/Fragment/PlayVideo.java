...
public class PlayVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String laytenphim = intent.getStringExtra("inputtenphim");
        binding.tvplayvideo.setText(laytenphim);

        laymangmp4 = intent.getStringArrayListExtra("inputmangmp4");
        int layvitri = intent.getIntExtra("inputvitri", 0);
